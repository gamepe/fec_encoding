...
char *  XSocket_pGetRcvDataPointer(XSOCKET *This, unsigned long  * pMsgSize, char * pKey = NULL);
BOOL    XSocket_bInitBufferSize(XSOCKET *This, unsigned long  dwBufferSize);
void    XSocket_XSocket(XSOCKET *This);
void    DXSocket_XSocket(XSOCKET *This);
int     XSocket_iOnRead(XSOCKET *, VOID *,  unsigned short);
